...
public class CigaretteSmokeController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (allPointsAdded)
        {
            Vector2 newOffset = new Vector2(lineSegment * (timeSinceUpdate / updateSpeed), lineMaterial.mainTextureOffset.y);
            lineMaterial.mainTextureOffset = newOffset;
        }
    }
